...
## Requirements
Build a responsive [login form](https://www.figma.com/design/aP8x5olXKsdXUShxpOzs71/Simple-Log-in-Page---Dekstop%2Fphone-(Community)?node-id=0-1&t=CCKIWiMHx82rHEED-1) in [React](https://react.dev/) and integrate the API.
